...
class BannerVendedores(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        link = f'https://aplicativosvendasaulahash-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        ...
        imagem = ImageButton(source=f"icones/fotos_perfil/{avatar}", 
                            ...
                            on_release= partial(meu_aplicativo.acessar_vendedor, valor))
